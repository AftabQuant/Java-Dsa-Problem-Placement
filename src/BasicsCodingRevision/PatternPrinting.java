...
public class PatternPrinting {
    ...
    public static void number_pyramid_palindrome(int n) {
        for(int i=1; i<=n; i++) {
            for(int j=1; j<=n-i; j++) {
                System.out.print("  ");
            }
    ...
    public static void star_bridge(int n) {
    ...
    public static void number_bridge(int n) {
    ...
    public static void star_hourglass2(int n) {
        int nst = 2*n - 1;
        int nsp = 0;
        for(int i=1; i<=n; i++) {
            for(int j=1; j<=nsp; j++) {
